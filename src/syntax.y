...
extern struct Pointer* root;
#define syntax_token_action(parent, name, lineno, n, ...) \
parent = make_root(SYNTAX_TOKEN_NODE, name, lineno, NULL, n, __VA_ARGS__);
%}
%define parse.error verbose
%locations
%union {
    struct Pointer *type_pointer;
}
